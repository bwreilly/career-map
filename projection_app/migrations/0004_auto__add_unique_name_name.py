...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Name', fields ['name']
        db.create_unique('careermap_name', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Name', fields ['name']
        db.delete_unique('careermap_name', ['name'])
